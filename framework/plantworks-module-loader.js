		...
		try {
			...
			for(const serviceName of initOrderList) {
				...
				try {
					...
					lifecycleStatus = new PlantWorksBaseError(`${this.$plantworksModule.name}::loader::_startServices::${serviceName} error`, err);
				}
			...
			return {
				'type': 'services',
				'status': new PlantWorksBaseError(`${this.$plantworksModule.name}::loader::_startServices error`, err)
			};
		}
	}

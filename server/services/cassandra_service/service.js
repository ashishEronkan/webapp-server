 ...
 * @classdesc The Plant.Works Web Application Server Cassandra Service.
 *
 * @description
 * Allows the rest of the Plant.Works Modules to use Cassandra as a NoSQL Storage.
 *
 */
class CassandraService extends PlantWorksBaseService {
	// #region Constructor
	...
	async _onCassandraError() {
		...
		const mailOptions = {
			...
			'to': 'vish@eronkan.com',
			'subject': 'Plant.Works Cassandra Error',
	...
	async _onCassandraHostDown(host) {
		...
		const mailOptions = {
			'from': 'root@plantworks.io',
			'to': 'vish@eronkan.com',
			'subject': 'Plant.Works Cassandra Host Down',
	...
	async _onCassandraHostRemoved(host) {
		...
		const mailOptions = {
			'from': 'root@plantworks.io',
			'to': 'vish@eronkan.com',
			'subject': 'Plant.Works Cassandra Host Removed',

...
class Main extends PlantWorksBaseComponent {
	...
	async _addRoutes() {
		try {
			this.$router.get('/warehouses', this.$parent._rbac('warehouse-manager-read'), this._getAllWarehouses.bind(this));

			this.$router.get('/warehouses/:tenant_warehouse_id', this.$parent._rbac('warehouse-manager-read'), this._getWarehouse.bind(this));
			this.$router.post('/warehouses', this.$parent._rbac('warehouse-manager-update'), this._addWarehouse.bind(this));
			this.$router.del('/warehouses/:tenant_warehouse_id', this.$parent._rbac('warehouse-manager-update'), this._deleteWarehouse.bind(this));
